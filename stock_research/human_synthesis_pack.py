...
def format_human_synthesis_pack_markdown(
    ...
    lines = [
        ...
        "5. Depth floor: preserve at least the same investor-useful insight coverage as the opportunity assessment, but reorganize it into a clearer story with less repetition. Do not summarize away the useful details.",
