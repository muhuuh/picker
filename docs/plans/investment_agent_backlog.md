...
- [x] Build company research sub-orchestrator.
  ...
  - Current progress: first SDK version registered as `company_research_orchestrator`; it builds a one-ticker lane packet, uses company-news fanout, and aggregates missing lanes into next-run tasks.
