...
| HRQ-0007 | 2026-05-10 | Review discovery candidate ADS-TEC Energy (ADSE) for verification before monitoring. | Approve follow-up company and financial verification before considering monitoring. | medium | open | agents/runs/2026-05-10_manual-market-energy-storage/market_research | agents/runs/2026-05-10_manual-market-energy-storage/market_research/candidate_review.md#CRG-0004 | Candidate surfaced from exa with verification=exa_only, hype=unknown, cooldown=not_rejected. Tickers: ADSE. Source IDs: exa_result_1. |
