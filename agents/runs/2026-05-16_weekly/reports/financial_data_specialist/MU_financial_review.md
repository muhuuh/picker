...
| --- | --- | --- | --- |
| company_name | Micron Technology, Inc. | medium | polygon |
| latest_price | 724.7 | high | polygon, yfinance |
| market_cap | 8.172e+11 | high | polygon, yfinance |
| pe_ratio | 34.25 | medium | yfinance |
| currency | usd | high | polygon, yfinance |
| exchange | XNAS | high | polygon, yfinance |
| sector | Technology | medium | yfinance |
| industry | Semiconductors | medium | yfinance |

## Review Notes

- financial_compare packet: `agents/runs/2026-05-16_weekly/evidence_packets/2026-05-16_financial_compare_company_mu.json`
- confidence_counts: {"high": 4, "medium": 11}
- status_counts: {"consistent": 15}
